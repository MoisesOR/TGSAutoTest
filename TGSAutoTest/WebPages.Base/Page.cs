...
namespace TGSAutoTest.WebPages.Base
{
    public class Page
    {
        ...
        {
            var asd = Jse2.ExecuteScript("return document.readyState");
            if (!Jse2.ExecuteScript("return document.readyState").ToString().Equals("complete") || Jse2.ExecuteScript("return document.readyState").Equals(null) || Jse2.ExecuteScript("return document.readyState") == null)
            {
                Thread.Sleep(5000);
                WaitForPageLoad();
            }
